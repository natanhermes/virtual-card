...
export type ScheduledOperationAffectedDocument = Asset | Collaborator;
...
export type GetCollaboratorInfoByNameQueryVariables = Exact<{
  name: Scalars['String'];
}>;

export type GetCollaboratorInfoByNameQuery = {
  __typename?: 'Query';
  collaborators: Array<{
    __typename?: 'Collaborator';
    githubUrl?: string | null;
...
`;
export type CreateCollaboratorMutationFn = Apollo.MutationFunction<
...
export function useCreateCollaboratorMutation(
  ...
  return Apollo.useMutation<
    CreateCollaboratorMutation,
    CreateCollaboratorMutationVariables
  >(CreateCollaboratorDocument, options);
}
export type CreateCollaboratorMutationHookResult = ReturnType<
  typeof useCreateCollaboratorMutation
>;
export type CreateCollaboratorMutationResult =
  Apollo.MutationResult<CreateCollaboratorMutation>;
export type CreateCollaboratorMutationOptions = Apollo.BaseMutationOptions<
  CreateCollaboratorMutation,
  CreateCollaboratorMutationVariables
>;
export const GetCollaboratorInfoByNameDocument = gql`
...
/**
 * __useGetCollaboratorInfoByNameQuery__
 *
 * To run a query within a React component, call `useGetCollaboratorInfoByNameQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCollaboratorInfoByNameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCollaboratorInfoByNameQuery({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useGetCollaboratorInfoByNameQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCollaboratorInfoByNameQuery,
    GetCollaboratorInfoByNameQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetCollaboratorInfoByNameQuery,
    GetCollaboratorInfoByNameQueryVariables
  >(GetCollaboratorInfoByNameDocument, options);
}
export function useGetCollaboratorInfoByNameLazyQuery(
...
export type GetCollaboratorInfoByNameQueryHookResult = ReturnType<
  typeof useGetCollaboratorInfoByNameQuery
>;
export type GetCollaboratorInfoByNameLazyQueryHookResult = ReturnType<
  typeof useGetCollaboratorInfoByNameLazyQuery
>;
export type GetCollaboratorInfoByNameQueryResult = Apollo.QueryResult<
  GetCollaboratorInfoByNameQuery,
  GetCollaboratorInfoByNameQueryVariables
>;
